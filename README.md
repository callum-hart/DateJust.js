# DateJust.js ![](https://badge-size.herokuapp.com/callum-hart/DateJust.js/master/lib/js/date-just.min.js?&color=00DB90) ![](https://badge-size.herokuapp.com/callum-hart/DateJust.js/master/lib/js/date-just.min.js?&compression=gzip&color=00DB90)
